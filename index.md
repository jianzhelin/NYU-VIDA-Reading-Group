...
```
```markdown 
Apr. 20, 2021        Monde Duinkharjav        Gaze Tracking
...
&emsp;**Date** &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; **Presenter** &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; **Topic and Paper**
```markdown 
Mar. 31, 2021        Eric Mazumdar            Societal Systems
                                              Learning & Decision-Making in Societal Systems: Theory, Algorithms, and Design
```
```markdown 
Mar. 26, 2021       Ellen Vitercik            ML for algorithm design
                                              Integrating machine learning into algorithm design
```
```markdown 
Mar. 18, 2021       Wilko Schwarting          Interactions in Mixed Human-Robot Environments
                                              Learning and Control for Interactions in Mixed Human-Robot Environments
```
```markdown 
Mar. 23, 2021       Alekh Agarwal             Reinforcement Learning
                                              Structural Foundations of Efficient Reinforcement Learning
```
```markdown 
Mar. 2, 2021        Dani Yogatama             Title Learning
                                              Title Learning General Language Processing Agents
```
```markdown 
Mar. 18, 2021       Kalesha Bullard           Interaction in Cooperative Multi-Agent Systems
                                              Learning through Interaction in Cooperative Multi-Agent Systems
```
```markdown 
Mar. 15, 2021      Michelle Lee               Fusion
                                              Fusion for Robot Perception and Controls
```
```markdown 
Mar. 11, 2021      Manish Raghavan            Algorithm decision making
                                              The Societal Impacts of Algorithmic Decision-Making
```
```markdown 
Mar. 10, 2021      Urvashi Khandelwal         NLP Interpretability
                                              The Generalizability and Interpretability of Neural Language Models
```
```markdown 
Mar. 8, 2021       Sarah Dean                 Reliable ML
                                              Reliable Machine Learning in Feedback Systems
```
```markdown 
Mar. 3, 2021       Bolei Zhou                 ML Interpretability
                                              Understanding Human-Centric Sides of Deep AI Models
```
```markdown 
Mar. 1, 2021        Mengye Ren                Natural AI
                                              Steps towards making machine learning more natural
```
```markdown 
Feb. 26, 2021        Theodora Chaspari        Medical AI based on human-technology 
                                              Human-centered computing for health and well-being: From reliable machine intelligence to trustworthy human-technology partnerships
```
```markdown 
Feb. 24, 2021        Pranav Rajpurkar         Medical AI
                                              Advancements and Challenges for Deep Learning in Medical Imaging
```
```markdown 
Feb. 16, 2021        Sanmi Koyejo             Trustworthy ML
